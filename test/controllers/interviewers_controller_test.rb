...
class InterviewersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interviewer" do
    assert_difference('Interviewer.count') do
      post interviewers_url, params: { interviewer: { job_title: @interviewer.job_title, name: @interviewer.name } }
    end
  ...
  test "should update interviewer" do
    patch interviewer_url(@interviewer), params: { interviewer: { job_title: @interviewer.job_title, name: @interviewer.name } }
