...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post interviews_url, params: { interview: { candidate_id: @interview.candidate_id, interviewer_id: @interview.interviewer_id, score_id: @interview.score_id } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { candidate_id: @interview.candidate_id, interviewer_id: @interview.interviewer_id, score_id: @interview.score_id } }
